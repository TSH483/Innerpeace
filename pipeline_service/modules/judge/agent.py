...
class JudgeAgent(BaseAgent):
    ...
    def _build_extra_body(self) -> dict[str, Any]:
        ...
        if self.reasoning_effort:
            ...
            # No reasoning_effort configured: force thinking OFF for vLLM
            # thinking models. Otherwise the judge spends the whole max_tokens
            # budget on a <think> chain and emits no JSON content
            # (finish_reason="length" -> "Judge returned empty response").
